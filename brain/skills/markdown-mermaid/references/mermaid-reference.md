# Mermaid Reference — Tool Selection, Palettes, Pitfalls

> Extracted from markdown-mermaid/SKILL.md on 2026-05-26 to keep the
> skill body lean. The skill points here for deep-dive content;
> consult on demand when authoring or debugging diagrams.
