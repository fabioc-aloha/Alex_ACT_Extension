...
| `cognitive-config.json` | Heir | First-installed, then frozen | `knowledge-coverage.instructions.md` (e.g. `showConfidenceBadge`), `.github/scripts/_registry.cjs` (shared memory bus resolution) |
